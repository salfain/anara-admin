import { LayoutDashboard, MessagesSquare, BarChart3, Users, FolderOpen, Send, ClipboardList, Receipt, CalendarCheck, FileText } from 'lucide-react';
...
export const navItems = [
  ...
  { to: '/invoices', label: 'Invoice', short: 'Invoice', icon: FileText, permission: 'billing.view' },
